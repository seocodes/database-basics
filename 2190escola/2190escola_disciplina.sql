...
CREATE TABLE `disciplina` (
  ...
  CONSTRAINT `disciplina_ibfk_1` FOREIGN KEY (`codcurso`) REFERENCES `curso` (`codigo`),
  CONSTRAINT `disciplina_ibfk_2` FOREIGN KEY (`codprofessor`) REFERENCES `professor` (`codigo`)
